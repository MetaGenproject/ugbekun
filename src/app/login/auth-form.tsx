...
import { Sun, Moon, Mail, Lock, Eye, EyeOff, UserRound, LockKeyhole, CheckCircle2, ShieldCheck, Settings, GraduationCap, User, Heart, Twitter, Github } from "lucide-react";
        ...
        <div className="rounded-2xl border bg-card/80 text-card-foreground shadow-2xl backdrop-blur-lg md:grid md:grid-cols-2 overflow-hidden">
            <div className="flex flex-col">
                <div className="flex items-center justify-between p-2">
                    ...
                    <button onClick={() => setTheme(resolvedTheme === 'dark' ? 'light' : 'dark')} className="mr-2 h-9 w-9 rounded-lg grid place-items-center border bg-background shadow-sm hover:bg-muted transition-colors" aria-label="Toggle theme">
                        ...
                        <section id="panel-signup" className="animate-in-up">
                          <div className="w-full max-w-sm mx-auto">
                            <header className="text-center mb-6">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">Join the Ugbekun platform today.</p>
                            </header>
